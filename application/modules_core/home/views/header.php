        ...
        <nav class="navbar navbar-default">
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              ...
              <?php $sess = $this->session->userdata('logged_in'); if($sess["validated"]==1)
			  {?>
                  <ul class="nav pull-right">
					<li class="dropdown">
					<a class="dropdown-toggle navbar-btn nav-button" href="#" data-toggle="dropdown"><?php echo $sess["firstname"];?> <strong class="caret"></strong></a>
						<div class="dropdown-menu" style="padding: 15px; padding-bottom: 0px;">
							<a  href="<?php echo base_url(); ?>index.php/home/profile" class="btn btn-primary btn-block" >My Profile</a>
                            <a  href="<?php echo base_url(); ?>index.php/home/memberLowongan" class="btn btn-primary btn-block" >My Apply</a>
                ...
                <?php } else { ?>
                 <ul class="nav pull-right">
					...
					<a class="dropdown-toggle navbar-btn nav-button" href="#" data-toggle="dropdown">Sign In <strong class="caret"></strong></a>
						<div class="dropdown-menu" style="padding: 15px; padding-bottom: 0px;">
							<form action="<?php echo base_url();?>index.php/home/process_login" role="form" method="post">
