        ...
        <nav class="navbar navbar-default">
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              ...
              <?php $sess = $this->session->userdata('logged_in_admin'); if($sess["validated"]==1)
			  {?>
                  <ul class="nav pull-right">
					<li class="dropdown">
					<a class="dropdown-toggle navbar-btn nav-button" href="#" data-toggle="dropdown">Admin<strong class="caret"></strong></a>
						<div class="dropdown-menu" style="padding: 15px; padding-bottom: 0px;">
							<a  href="<?php echo base_url(); ?>index.php/home/adminPanel" class="btn btn-primary btn-block" >Admin Panel</a>
